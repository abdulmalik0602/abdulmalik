  ...
  const projects = [
    {
      ...
      description: 'Offers users a comprehensive daily health management solution with emergency support and direct medical access through a single app.',
      fullDescription: "Daily Health Partner is a comprehensive mobile health tracking application designed to empower users with real-time insights into their daily wellness. Built with Flutter and Firebase, the app connects seamlessly with smartwatches and fitness wearables to continuously monitor vital health metrics such as heart rate, SpO2 (oxygen levels), step count, and other personalized health indicators. It also includes a BMI (Body Mass Index) calculator for quick health assessments.One of the standout features is the integration of Google Maps, which allows users to locate nearby hospitals during emergencies and call ambulances directly through the app. The platform also supports a blood request system, enabling users to send requests directly to nearby blood banks or donors in critical situations.Furthermore, the app streamlines medication access by allowing users to upload prescriptions and directly communicate with pharmacies. To enhance doctor-patient interaction, it supports real-time communication features, including text chat, voice calls, and video consultations—making it a reliable, all-in-one digital health companion.Firebase services like Firestore and Realtime Database ensure smooth, synchronized data handling, while Firebase In-App Messaging helps deliver timely health alerts, appointment reminders, or personalized messages. A Single Sign-On (SSO) mechanism is used to enable easy, secure access for users.",
      image: 'https://wallpapers.com/images/featured/healthcare-oco8w27tkw40cp90.jpg',
      technologies: ['Flutter', 'Firebase(Firestore, Realtime Database, In-App Messaging)', 'Google Maps API','SSO'],
      category: 'Mobile',
      github: 'https://github.com/abdulmalik0602',
      live: '#',
      highlights: [
        'Smartwatch Integration: Heart rate, SpO2, steps tracking, and daily health stats',
        'BMI Calculator for instant body analysis',
        'Nearby Hospital Finder using Google Maps API',
        'Emergency Ambulance Call system',
        'Blood Request Module for direct requests to donors or banks',
        'Prescription-Based Pharmacy Contact with real-time chat support',
        ' Secure Real-Time Chat, Voice & Video Calls',
        'Firebase In-App Messaging for health tips and reminders',
        'Single Sign-On (SSO) for seamless user authentication',
        'Firebase Firestore & Realtime DB for robust data handling'
      ],
